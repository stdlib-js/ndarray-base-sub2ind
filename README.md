...
```javascript
sub2ind = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-sub2ind@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-sub2ind@umd/bundle.js"></script>
```
